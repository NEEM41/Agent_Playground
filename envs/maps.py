...
""",
    ...
    # 1) Easy open room (baseline generalization)
    "easy_room": r"""
###############
#S............#
#.............#
...
""",
    ...
    # 2) Two turns corridor (still easy, tests turns)
    "two_turns": r"""
####################
#S.............#...#
#######.#########..#
...
""",
    ...
    # 3) Trap corridor: direct path crosses traps, safe detour exists
    "trap_corridor": r"""
####################
#S..T..T..T..T....G#
# ################.#
...
""",
    ...
    # 4) Trap choice: short risky route vs longer safe route
    "trap_choice": r"""
####################
#S....##########...#
#....T....T....#...#
...
""",
    ...
    # 5) Junction + dead ends (forces exploration)
    "dead_ends": r"""
####################
#S.....#...........#
#.###.###.#####.##.#
...
""",
    ...
    # 6) Small maze with reachable traps near optimal route
    "maze_traps": r"""
####################
#S....#.......#...G#
#.#.###.#####.#.##.#
